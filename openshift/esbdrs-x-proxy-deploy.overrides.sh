# ========================================================================
# Special Deployment Parameters needed for the esbdrs-x-proxy instance.
# ------------------------------------------------------------------------
...
CONFIG_MAP_NAME=esbdrs-x-proxy-caddy-conf
SOURCE_FILE=../esbdrs-x/caddy/Caddyfile
OUTPUT_FORMAT=json
OUTPUT_FILE=esbdrs-x-proxy-caddy-configmap_DeploymentConfig.json

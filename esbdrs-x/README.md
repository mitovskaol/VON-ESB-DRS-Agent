...
The default registration form can then be found at `http://localhost:5000/esbdrs/registration`

Note that this project contains configuration for the credentials generated by the BC ESB DRS (foreign worker registrations).
